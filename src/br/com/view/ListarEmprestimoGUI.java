...
public class ListarEmprestimoGUI extends javax.swing.JFrame {
    
private JTable tabela = new JTable();

private DefaultTableModel modelo = new DefaultTableModel();

    public ListarEmprestimoGUI() {
        initComponents();
        criaTabela();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/emprestimo.png"))); // NOI18N
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if(linhaSelecionada >= 0) {
            ...
            EmprestimoGUI gui = new EmprestimoGUI (modelo, linhaSelecionada, idEmprestimo);
            gui.setVisible(true);
            
            
        }else{
           JOptionPane.showMessageDialog(null,"É necessario selecionar um empréstimo.");
        }
    ...
    private void btDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btDeletarActionPerformed
      int linhaSelecionada = tabela.getSelectedRow();
        if(linhaSelecionada >= 0) {
            ...
            if (lc.remover(idEmprestimo) == true) {
    ...
    private void btNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoActionPerformed
      EmprestimoGUI gui = new EmprestimoGUI(modelo);
      gui.setVisible(true);
    ...
    private void txBuscaTituloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txBuscaTituloActionPerformed
       ...
       modelo.setNumRows(0);
       for (Emprestimo ee: ec.PesquisarEmprestimoNome(Nome)) {
            modelo.addRow(new Object[] {ee.getCodigo(),ee.getTipoPessoa(),ee.getLocador()});
    ...
    private void btBuscaNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscaNomeActionPerformed
         EmprestimoController ac = new EmprestimoController();
       String Nome = txBuscaTitulo.getText();
       modelo.setNumRows(0);
       for (Emprestimo li: ac.PesquisarEmprestimoNome(Nome)) {
           modelo.addRow(new Object[] {li.getCodigo(),li.getTipoPessoa(),li.getLocador()});
...
/**/
    ...
    // End of variables declaration//GEN-END:variables
       ...
       private void criaTabela() {
        ...
        modelo.addColumn("Locador");
        popularTabela();
        
    }

    private void popularTabela() {
       EmprestimoController clc = new EmprestimoController();
        for (Emprestimo li: clc.ListarEmprestimo()) {
            modelo.addRow(new Object[] {li.getCodigo(),li.getTipoPessoa(),li.getLocador()});
    }
}
}
