...
public class EntradaExemplarGUI extends javax.swing.JFrame {
    ...
    private DefaultComboBoxModel modeloLivro;
    private DefaultComboBoxModel modeloDvd;
   ...
   public EntradaExemplarGUI(DefaultTableModel modelo, int linhaSelecionada, int idEntradaExemplar) {
       ...
       cbNomeExemplar.setSelectedItem(ee.getDvd());
       cbNomeExemplar.setSelectedItem(ee.getLivro());
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/entradaExemplar.png"))); // NOI18N
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(cbNomeExemplar, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
...
//           
       ...
       try{
           String DataAquisicao = txDataEntrada.getText();
           ee.setDataAquisicao(new SimpleDateFormat("dd/MM/yyyy").parse(DataAquisicao));
       }catch(Exception e){
           JOptionPane.showMessageDialog(null,"Data de Cadastro no formato incorreto" +e.getMessage());
       }
       ee.setDvd((Dvd)cbNomeExemplar.getSelectedItem());
       ee.setLivro((Livro)cbNomeExemplar.getSelectedItem());
       ...
       if(eSalvo != null){
           modelo.addRow(new Object[] { 
               eSalvo.getCodigo(),eSalvo.getDataAquisicao()});
       }
...
//    }
    ...
    private void carregarComboLivro() {
        modeloLivro = (DefaultComboBoxModel)cbNomeExemplar.getModel();
        modeloLivro.removeAllElements();
        LivroController lc = new LivroController();
        for (Livro l: lc.ListarLivro()) {
            modeloLivro.addElement(l);
        }
    }

    private void carregarComboDvd() {
        modeloDvd = (DefaultComboBoxModel)cbNomeExemplar.getModel();
        modeloDvd.removeAllElements();
        DvdController dc = new DvdController();
        for (Dvd d: dc.ListarDvd()) {
            modeloDvd.addElement(d);
        }
    }
}
