 ...
 * @author Emily
 */
public class AssuntoGUI extends javax.swing.JFrame {
    private DefaultTableModel modelo;
    private int linhaSeIecionada;
   
    
    
    public AssuntoGUI(DefaultTableModel modelo) {
        this.modelo = modelo;
        initComponents();
    }

    
    public AssuntoGUI(DefaultTableModel modelo, int linhaSelecionada, int IdAssunto){
        this.modelo = modelo;
        this.linhaSeIecionada = linhaSelecionada;
        initComponents();
        
        AssuntoController ac = new AssuntoController();
        Assunto a = ac.pesquisarCodigo(IdAssunto);
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/assunto.png"))); // NOI18N
    ...
    private void btSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSalvarActionPerformed
        ...
        AssuntoController ac = new AssuntoController();
        Assunto aSalvo = ac.salvar(a);
        if(aSalvo != null){
            modelo.addRow(new Object[]{ aSalvo.getCodigo(),aSalvo.getDescricao()});
        }
