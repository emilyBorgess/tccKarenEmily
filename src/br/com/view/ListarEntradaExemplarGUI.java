...
private DefaultTableModel modelo = new DefaultTableModel();
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addComponent(jPanel5, javax.swing.GroupLayout.PREFERRED_SIZE, 665, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(0, 0, Short.MAX_VALUE))
        );
    ...
    private void txBuscaTituloActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txBuscaTituloActionPerformed
       ...
       for (EntradaExemplar ee: ec.PesquisarEntradaExemplarNomeExemplar(Titulo)) {
            modelo.addRow(new Object[] {ee.getCodigo(),ee.getDataAquisicao()});
    ...
    private void btBuscaNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscaNomeActionPerformed
       ...
       for (EntradaExemplar li: ac.PesquisarEntradaExemplarNomeExemplar(Titulo)) {
           modelo.addRow(new Object[] {li.getCodigo(),li.getDataAquisicao()});
