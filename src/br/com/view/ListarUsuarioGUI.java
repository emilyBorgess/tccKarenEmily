...
public class ListarUsuarioGUI extends javax.swing.JFrame {
    ...
    private void btNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btNovoActionPerformed
        UsuarioGUI gui = new UsuarioGUI(modelo);
        gui.setVisible(true);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
       int linhaSelecionada = tabela.getSelectedRow();
        if(linhaSelecionada >= 0) {
            int idUsuario = (int) tabela.getValueAt(linhaSelecionada, 0);
           UsuarioGUI gui = new UsuarioGUI (modelo, linhaSelecionada, idUsuario);
            gui.setVisible(true);
    ...
    private void txBuscaNomeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txBuscaNomeActionPerformed
       ...
       modelo.setNumRows(0);
       for (Usuario c: cc.PesquisarUsuarioNome(Nome)) {
           modelo.addRow(new Object[] {c.getCodigo(),c.getNomeUsuario()});
    ...
    private void popularTabela() {
        UsuarioController cc = new UsuarioController();
        for(Usuario c: cc.ListarUsuario()) {
            modelo.addRow(new Object[] { c.getCodigo(), c.getNomeUsuario()});
        }
    }
}
