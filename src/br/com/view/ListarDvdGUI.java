...
public class ListarDvdGUI extends javax.swing.JFrame {
...
private DefaultTableModel modelo = new DefaultTableModel();
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        if(linhaSelecionada >= 0) {
            int idDvd = (int) tabela.getValueAt(linhaSelecionada, 0);
            DvdGUI gui = new DvdGUI (modelo, linhaSelecionada, idDvd);
            gui.setVisible(true);
            
            
        }else{
           JOptionPane.showMessageDialog(null,"É necessario selecionar um dvd.");
        }
